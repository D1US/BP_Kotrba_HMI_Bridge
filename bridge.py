...
# Confirmed via /debug_symbols against the real running PLC - these are
# flat globals (leading dot, no GVL prefix), all uppercase.
SYM_START = '.BSTART'
SYM_STOP = '.BSTOP'
SYM_MODE = '.BMODE'
...
@app.route('/debug_symbols', methods=['GET'])
def debug_symbols():
    with get_plc() as plc:
